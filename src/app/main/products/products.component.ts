        ...
        this.dataTable = [
            {
                ...
                ASIN: 'B07C6YRBG2',
                name:
                    '[MagicBike®] 2 chambres à air Trottinette Electrique Xiaomi M365 8 1/2x2 (Nouvelle Version Mars 2019 ) Double Epaisseur (1.8mm)/ Renforcement valve 4 cm [Qualité Premium] + 2m de cache câble',
                handle: 'product-1',
                stock: 128,
                price: 19.9,
                sales: 67,
